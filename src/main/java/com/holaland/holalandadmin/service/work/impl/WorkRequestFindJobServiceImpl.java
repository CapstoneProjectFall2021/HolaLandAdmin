...
public class WorkRequestFindJobServiceImpl implements WorkRequestFindJobService {
    ...
    @Override
    public boolean requestFindJobApprove(int id) throws DataAccessException {
        return workRequestFindJobRepository.requestFindJobApprove(id);
    }

    @Override
    public boolean cancel(WorkRequestFindJob obj) throws DataAccessException {
        return workRequestFindJobRepository.cancel(obj);
    }
